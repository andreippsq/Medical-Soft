...
class ForumPatient extends StatefulWidget {
  @override
  _ForumStatePatient createState() => _ForumStatePatient();
}

class _ForumStatePatient extends State<ForumPatient> {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                      ...
                      child: Container(
                        child: Image.asset(
                          'assets/images/forum_image.png', height: 200, width: 200,),
                      )
                  ),
                  Expanded(

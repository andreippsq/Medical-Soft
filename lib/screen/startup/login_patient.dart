...
class LogInPatient extends StatefulWidget {
  final Function onSignUpPatientSelected;

  LogInPatient({@required this.onSignUpPatientSelected});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "You do not have an account as a patient?",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 14,
                            ),
                          ...
                          GestureDetector(
                            onTap: () {
                              widget.onSignUpPatientSelected();
                            },
                            child: Row(
                              children: [
                                Text(

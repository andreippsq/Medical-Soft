...
class TherapyJournalPatient extends StatefulWidget {
  @override
  _TherapyJournalPatientState createState() => _TherapyJournalPatientState();
}

class _TherapyJournalPatientState extends State<TherapyJournalPatient> {
  @override
